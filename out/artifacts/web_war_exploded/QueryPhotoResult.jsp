    		...
    		<c:forEach items="${list}" var="photo" varStatus="num">
    			...
    			<tr>
    				<td colspan="4" align="right">
    					<a href="QueryPhotoServlet?aid=${aid}&pname=${pname}&currentPage=1">首页</a>
    					<a href="QueryPhotoServlet?aid=${aid}&pname=${pname}&currentPage=${currentPage-1}">上一页</a>
    					
    					<a href="QueryPhotoServlet?aid=${aid}&pname=${pname}&currentPage=${currentPage+1}">下一页</a>
    					<a href="QueryPhotoServlet?aid=${aid}&pname=${pname}&currentPage=${totalPage}">尾页</a>
    				</td>
    			</tr>
    	</table>
    </form>
